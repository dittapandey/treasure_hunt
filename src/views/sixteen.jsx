    ...
    return ( 
        <div>
            ...
            <div classname="containerTwo">
                <p>Slide the grid squares around so that the numbers end up in consecutive order from the top left corner.
                Click on the arrows at the edges of the grid to move a row or column left, right, up or down. The square that falls off the end of the row comes back on the other end.Click on shuffle to start game.</p>
            </div>
            <div id="done">WELL DONE! CLICK SUBMIT BUTTON</div>
            <div id="submittedGame">
                <div id="board">
                <div id="moves">
                    <div classname="container">
                    <button classname="but" id="shuffle" name="hidInputShuffle" value>START GAME</button>
                    <form classname action="/" method="post">
                        <button classname="but" id="subbtn" type="submit" onclick={submitFunction} name="submitBtn" value>SUBMIT GAME</button>
                        <input type="hidden" name="hidInputOne" id="one" defaultvalue />
                        <input type="hidden" name="hidInputTwo" id="two" defaultvalue />
                        <input type="hidden" name="hidInputThree" id="three" defaultvalue />
                        <input type="hidden" name="hidInputFour" id="four" defaultvalue />
                    </form>
                    </div>
                </div>
                </div>
